...
class Contacts final :
 ...
 public:
  ...
  public:
  void clear_people();
  ::contacts::PeopleInfo* mutable_people(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts::PeopleInfo >*
      mutable_people();
  private:
  const ::contacts::PeopleInfo& _internal_people(int index) const;
  ::contacts::PeopleInfo* _internal_add_people();
  public:
  const ::contacts::PeopleInfo& people(int index) const;
  ::contacts::PeopleInfo* add_people();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts::PeopleInfo > people_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_test_2eproto;
...
inline const std::string& PeopleInfo_Phone::phone_number() const {
  // @@protoc_insertion_point(field_get:contacts.PeopleInfo.Phone.phone_number)
...
void PeopleInfo_Phone::set_phone_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.phone_number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts.PeopleInfo.Phone.phone_number)
}
inline std::string* PeopleInfo_Phone::mutable_phone_number() {
  std::string* _s = _internal_mutable_phone_number();
  // @@protoc_insertion_point(field_mutable:contacts.PeopleInfo.Phone.phone_number)
  return _s;
}
...
inline std::string* PeopleInfo_Phone::release_phone_number() {
  // @@protoc_insertion_point(field_release:contacts.PeopleInfo.Phone.phone_number)
...
inline ::contacts::PeopleInfo* Contacts::mutable_people(int index) {
...
inline const ::contacts::PeopleInfo& Contacts::_internal_people(int index) const {
  return _impl_.people_.Get(index);
}
inline const ::contacts::PeopleInfo& Contacts::people(int index) const {
  // @@protoc_insertion_point(field_get:contacts.Contacts.people)
  return _internal_people(index);
}
inline ::contacts::PeopleInfo* Contacts::_internal_add_people() {
  return _impl_.people_.Add();
}
inline ::contacts::PeopleInfo* Contacts::add_people() {
  ::contacts::PeopleInfo* _add = _internal_add_people();
